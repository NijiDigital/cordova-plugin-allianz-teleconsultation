...
#import "CDVAllianzWKInAppBrowserUIDelegate.h"
...
@property (nonatomic, retain) CDVAllianzWKInAppBrowser* instance;
@property (nonatomic, retain) CDVAllianzWKInAppBrowserViewController* inAppBrowserViewController;
...
@property (nonatomic, strong) IBOutlet CDVAllianzWKInAppBrowserUIDelegate* webViewUIDelegate;

@property (nonatomic, weak) id <CDVScreenOrientationDelegate> orientationDelegate;
@property (nonatomic, weak) CDVAllianzWKInAppBrowser* navigationDelegate;
