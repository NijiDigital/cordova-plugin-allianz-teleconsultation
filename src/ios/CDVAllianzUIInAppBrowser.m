...
#pragma mark CDVAllianzUIInAppBrowser

@interface CDVAllianzUIInAppBrowser () {
    NSInteger _previousStatusBarStyle;
}
@end

@implementation CDVAllianzUIInAppBrowser

static CDVAllianzUIInAppBrowser* instance = nil;
...
- (void)openInInAppBrowser:(NSURL*)url withOptions:(NSString*)options
{
    ...
    if (self.inAppBrowserViewController == nil) {
        ...
        self.inAppBrowserViewController = [[CDVAllianzUIInAppBrowserViewController alloc] initWithUserAgent:userAgent prevUserAgent:[self.commandDelegate userAgent] browserOptions: browserOptions];
...
- (void)show:(CDVInvokedUrlCommand*)command
{
    ...
    __weak CDVAllianzUIInAppBrowser* weakSelf = self;
...
#pragma mark CDVAllianzUIInAppBrowserViewController

@implementation CDVAllianzUIInAppBrowserViewController
...
- (void)navigateTo:(NSURL*)url
{
    ...
    if (_userAgentLockToken != 0) {
        ...
        __weak CDVAllianzUIInAppBrowserViewController* weakSelf = self;
